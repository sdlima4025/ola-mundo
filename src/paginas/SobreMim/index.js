  ...
  return (
    <PostModelo fotoCapa={fotoCapa} titulo="Sobre Mim">
      ...
      <p className={styles.paragrafo}>
        ...
        Estudei Contabilidade e no estágio tive contato com um operador de tela preta, e sempre gostei muito do mundo tecnologico mas não tinha
      ...
      <p className={styles.paragrafo}>
        ...
        {/* verifico se a falha é de usabilidade do usuário ou BUG do sistema. E foi enquanto eu estava no PET que decidi procurar um
